...
description = "Average-DJ here for the party just do ***;help***"
...
class Bot(commands.Bot):
    ...
    async def shutdown(self, *, restart=False):
        """Gracefully quits Average-DJ with exit code 0

        If restart is True, the exit code will be 26 instead
        The launcher automatically restarts Average-DJ when that happens"""
...
def initialize(bot_class=Bot, formatter_class=Formatter):
    ...
    async def on_ready():
        ...
        print("\nOfficial server: https://discord.gg/d6xzQbv")
...
def interactive_setup(settings):
    ...
    if first_run:
        print("Average-DJ - First run configuration\n")
        print("If you haven't already, create a new account:\n"
              "#creating-a-new-bot-account")
              "https://discord.gg/d6xzQbv"
